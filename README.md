...
6. Either download the tool directly from your router's ssh prompt type: `wget https://github.com/vortex-5/ddwrt-bwmon/releases/download/1.14.0/bwmon.tar.gz`. Alternatively you can download the file from the releases page and copy it to your usb flash drive.
...
**Update:** The latest tested version of DD-WRT confirmed to be working is 40167 with this module.
