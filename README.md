...
Change log
----------
* **Feb-14-2015**: We are now using the releases feature on github to attach binaries and will not be checking in the binaries into version control this allows for better tested releases with real version numbers.
...
5. Either download the tool directly from your router's ssh prompt type: `wget https://github.com/vortex-5/ddwrt-bwmon/releases/download/1.1/bwmon.tar.gz`. Alternatively you can download the file above and copy it to your usb flash drive.
